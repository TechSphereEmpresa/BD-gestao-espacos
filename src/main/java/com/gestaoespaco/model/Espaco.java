...
public class Espaco {
	...
	public Espaco(String nome, String tipo, String localizacao, double metragrem, Integer capacidade) {
		this(0L, nome, tipo, localizacao, metragrem, capacidade);
	}
	
	public Espaco(Long id, String nome, String tipo, String localizacao, double metragrem, Integer capacidade) {
		this.id = id;
		this.nome = nome;
		this.tipo = tipo;
